...
def htmlBody():
    ...
    str+="<table border=0>"+"\n"
    str+="<tr><th>Filename</th><th>Base File</th>"
    str+="<tr><td>"+sdf_file1+" </td><td><input type='radio' name='base_file' value=1>"+"</td></tr>"+"\n"
    str+="<tr><td>"+sdf_file2+" </td><td><input type='radio' name='base_file' value=2>"+"</td></tr>"+"\n"
    str+="<tr><td>"+sdf_file3+" </td><td><input type='radio' name='base_file' value=3>"+"</td></tr>"+"\n"
    str+= "<tr><td>"+sdf_file4+" </td><td><input type='radio' name='base_file' value=4>"+"</td></tr>"+"\n"
    str+="<tr><td>"+sdf_file5+" </td><td><input type='radio' name='base_file' value=5>"+"</td></tr>"+"\n"
    str+="<tr><td>"+sdf_file6+" </td><td><input type='radio' name='base_file' value=6>"+"</td></tr>"+"\n"
