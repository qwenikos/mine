...
def htmlBody():
    ...
    str+="<table border=0>"+"\n"
    str+="<tr><td colspan=2 align=right>Rank Threshold     </td><td colspan=4><input type='text' name='rankThreshold'>"+"</td></tr>"+"\n"
    str+="<tr><td colspan=2 align=right>Energy Threshold</td><td colspan=4><input type='text' name='energyThreshold'>"+"</td></tr>"+"\n"
    str+="<td>"+"Rank Filter"+" </td><td><input type='radio' name='method' value=rank checked=checked>"+"</td>"+"\n"
    str+="<td>"+"Energy Filter"+" </td><td><input type='radio' name='method' value=energy>"+"</td>"+"\n"
    str+="<td>"+"Both"+" </td><td><input type='radio' name='method' value=both>"+"</td></tr>"+"\n"
    str+="</table>"+"\n"
    
    str+="<table border=0>"+"\n"
    str+="<tr><th colspan=6>Filename</th><th>Base File</th>"
    str+="<tr><td colspan=6>"+sdf_file1+" </td><td align=center><input type='radio' name='base_file' value=1 checked=checked>"+"</td></tr>"+"\n"
    str+="<tr><td colspan=6>"+sdf_file2+" </td><td align=center><input type='radio' name='base_file' value=2>"+"</td></tr>"+"\n"
    str+="<tr><td colspan=6>"+sdf_file3+" </td><td align=center><input type='radio' name='base_file' value=3>"+"</td></tr>"+"\n"
    str+= "<tr><td colspan=6>"+sdf_file4+" </td><td align=center><input type='radio' name='base_file' value=4>"+"</td></tr>"+"\n"
    str+="<tr><td colspan=6>"+sdf_file5+" </td><td align=center><input type='radio' name='base_file' value=5>"+"</td></tr>"+"\n"
    str+="<tr><td colspan=6>"+sdf_file6+" </td><td align=center><input type='radio' name='base_file' value=6>"+"</td></tr>"+"\n"
